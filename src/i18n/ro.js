...
export default {
    ...
    dataExchange: {
        ...
        backupHint: 'Creează un backup JSON complet al bazei de date active sau restaurează unul în providerul curent.',
        backupIncludes: 'Backup-ul include setări, clienți, produse, facturi, linii de factură, chitanțe, utilizatori și audit logs.',
        downloadBackup: 'Descarcă Backup-ul',
        restoreBackup: 'Restaurează Backup-ul',
        restoreBackupConfirm: 'Restaurezi acest backup în baza de date activă? Datele curente vor fi înlocuite.',
        backupDownloadSuccess: 'Backup-ul a fost descărcat',
        backupDownloadFailed: 'Descărcarea backup-ului a eșuat',
        restoreSuccess: 'Backup-ul a fost restaurat',
        restoreFailed: 'Restaurarea backup-ului a eșuat',
        invoiceImportMissingClient: 'Numele clientului este obligatoriu pentru facturile importate',
    },
    ...
    ai: {
        ...
        companyImportDisabledHint: 'Activează extragerea AI mai jos pentru a încărca aici un document al companiei.',
        companyImportMissingKeyHint: 'Salvează mai jos o cheie API OpenRouter pentru a încărca aici un document al companiei.',
        companyImportHint: 'Încarcă un PDF scanat sau o imagine pentru a extrage datele companiei și cele bancare.',
        uploadCompanyDocument: 'Încarcă Documentul',
        extractCompany: 'Extrage Datele Companiei',
        extractClient: 'Extrage Datele Clientului',
        importInvoice: 'Import AI',
        invoiceImportHint: 'Încarcă un PDF sau o imagine cu factura, apoi revizuiește valorile extrase înainte să le aplici în formular.',
        extractingInvoice: 'Se extrage factura...',
        ...
        reviewHint: 'Revizuiește valorile extrase înainte să le aplici în formular.',
        reviewInvoiceTitle: 'Revizuire Import Factură',
        warningsTitle: 'Observații de extragere',
        applySelected: 'Aplică Câmpurile Selectate',
        importSelected: 'Importă Selecția',
        noFieldsExtracted: 'Nu au fost extrase câmpuri utilizabile din document',
        applyColumn: 'Aplică',
        fieldColumn: 'Câmp',
        currentValueColumn: 'Valoare Curentă',
        extractedValueColumn: 'Valoare Extrasă',
        confidenceColumn: 'Încredere',
        reviewCompanyTitle: 'Revizuire Extragere Companie',
        reviewClientTitle: 'Revizuire Extragere Client',
        detectedClient: 'Client Detectat',
        detectedClientMatchHint: 'A fost găsit un client corespunzător în evidențele existente.',
        manualClientSelectionHint: 'Nu a fost găsită încă o potrivire sigură pentru client. Poți aplica totuși câmpurile facturii și rezolva clientul după import.',
        applyMatchedClient: 'Selectează clientul potrivit',
        clientMatchMissing: 'Niciun client existent nu se potrivește cu clientul extras. Aplică acum câmpurile facturii și selectează sau creează clientul după import.',
        matchedByCif: 'Potrivire după CIF',
        matchedByName: 'Potrivire după nume',
        detectedItems: 'Linii Detectate',
        replaceItemsHint: 'Poți înlocui liniile curente ale facturii cu produsele sau serviciile extrase.',
        replaceItems: 'Înlocuiește liniile curente',
        currentItemsCount: 'Linii curente: {count}',
        extractedItemsCount: 'Linii extrase: {count}',
        noItemsExtracted: 'Nu au fost extrase linii de factură cu suficientă încredere.',
        confidence: {
            high: 'Ridicată',
            medium: 'Medie',
            low: 'Scăzută',
