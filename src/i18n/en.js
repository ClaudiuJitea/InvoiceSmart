...
export default {
    ...
    dataExchange: {
        ...
        backupHint: 'Create a full JSON backup of the active database or restore one back into the current provider.',
        backupIncludes: 'Backups include settings, clients, products, invoices, invoice items, receipts, users, and audit logs.',
        downloadBackup: 'Download Backup',
        restoreBackup: 'Restore Backup',
        restoreBackupConfirm: 'Restore this backup into the active database? This replaces the current data.',
        ...
        invoiceImportMissingClient: 'Client name is required for imported invoices',
    },
    ...
    ai: {
        ...
        companyImportDisabledHint: 'Enable AI extraction below to upload a company document here.',
        companyImportMissingKeyHint: 'Save an OpenRouter API key below to upload a company document here.',
        companyImportHint: 'Upload a scanned PDF or image to extract company identity and bank details.',
        uploadCompanyDocument: 'Upload Document',
        extractCompany: 'Extract Company Details',
        extractClient: 'Extract Client Details',
        importInvoice: 'AI Import',
        invoiceImportHint: 'Upload a PDF or image of an invoice, then review the extracted values before applying them to the form.',
        extractingInvoice: 'Extracting invoice...',
        ...
        reviewHint: 'Review the extracted values before applying them to the form.',
        reviewInvoiceTitle: 'Review Invoice Import',
        warningsTitle: 'Extraction notes',
        applySelected: 'Apply Selected Fields',
        importSelected: 'Import Selected',
        noFieldsExtracted: 'No usable fields were extracted from the document',
        applyColumn: 'Apply',
        fieldColumn: 'Field',
        currentValueColumn: 'Current Value',
        extractedValueColumn: 'Extracted Value',
        confidenceColumn: 'Confidence',
        reviewCompanyTitle: 'Review Company Extraction',
        reviewClientTitle: 'Review Client Extraction',
        detectedClient: 'Detected Client',
        detectedClientMatchHint: 'A matching client was found in your existing records.',
        manualClientSelectionHint: 'No reliable client match was found yet. You can still apply the invoice fields and handle the client afterward.',
        applyMatchedClient: 'Select matched client',
        clientMatchMissing: 'No existing client matched the extracted client. Apply the invoice fields now and select or create the client afterward.',
        matchedByCif: 'Matched by CIF',
        matchedByName: 'Matched by name',
        detectedItems: 'Detected Items',
        replaceItemsHint: 'You can replace the current invoice rows with the extracted line items.',
        replaceItems: 'Replace current line items',
        currentItemsCount: 'Current items: {count}',
        extractedItemsCount: 'Extracted items: {count}',
        noItemsExtracted: 'No line items were extracted with enough confidence.',
        confidence: {
            high: 'High',
            medium: 'Medium',
            low: 'Low',
    ...
    settings: {
        ...
        databaseSettingsHint: 'Configure the database provider used by the backend API.',
        dbProvider: 'Provider',
        dbActiveProvider: 'Active provider',
        ...
        dbSqliteFilePath: 'SQLite File Path',
        dbHost: 'Host',
        dbPort: 'Port',
        dbName: 'Database Name',
        dbUser: 'Username',
        dbPassword: 'Password',
        dbPasswordKeepCurrent: 'Leave blank to keep current password',
        dbSsl: 'SSL',
        dbSslEnable: 'Enable SSL',
        dbTestConnection: 'Test Connection',
        dbSaveConfiguration: 'Save DB Configuration',
        dbTestSuccess: 'Connection successful',
        dbTestError: 'Connection failed',
        dbSaveSuccess: 'Database configuration saved',
        dbSaveError: 'Failed to save database configuration',
        dbOpenWizard: 'Migration Wizard',
        dbWizardTitle: 'Database Migration / Export-Import Wizard',
        dbWizardSourceTitle: 'Source (SQLite)',
        dbWizardTargetTitle: 'Target Database',
        dbWizardActionsTitle: 'Migration Actions',
        dbWizardActionsHint: 'Export a SQLite snapshot, import a snapshot into target DB, or run direct migration.',
        dbWizardExport: 'Export Snapshot',
        dbWizardImport: 'Import Snapshot',
        dbWizardMigrate: 'Migrate Now',
        dbWizardExportSuccess: 'Snapshot exported successfully',
        dbWizardExportError: 'Snapshot export failed',
        dbWizardImportSuccess: 'Snapshot imported successfully',
        dbWizardImportError: 'Snapshot import failed',
        dbWizardMigrateSuccess: 'Migration completed and provider updated',
        dbWizardMigrateError: 'Migration failed',
        dbValidationSqlitePath: 'SQLite file path is required',
        dbValidationMissingFields: 'Missing or invalid fields: {fields}',
